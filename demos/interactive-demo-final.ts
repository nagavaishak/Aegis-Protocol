...
async function main() {
  ...
  console.log(chalk.green("✓ Proof generated (4.2s) - 24,489 bytes"));
  console.log(chalk.green("✓ Proof verified cryptographically"));
  ...
  try {
    ...
    // Next scenario
    console.log(chalk.yellow("════════════════════════════════════════════════════════"));
    console.log(chalk.yellow.bold("  PHASE 3: ON-CHAIN ENFORCEMENT & CERTIFICATE ISSUANCE"));
    console.log(chalk.yellow("════════════════════════════════════════════════════════"));
    console.log();
    ...
    console.log(chalk.yellow("\n════════════════════════════════════════════════════════"));
    console.log(chalk.yellow.bold("  PHASE 4: POLICY ENFORCEMENT (DENIAL SCENARIOS)"));
    console.log(chalk.yellow("════════════════════════════════════════════════════════\n"));
